...
WELL is a pure-Python organ with a single-file FastMCP server (`server.py`, ~14K lines, **21 somatic tools**). It measures human readiness across 13 substrate signals, feeds evidence to arifOS, and holds no constitutional authority.
...
| Path | Purpose |
|------|---------|
| `server.py` | FastMCP server (~14K lines, 21 somatic tools) |
